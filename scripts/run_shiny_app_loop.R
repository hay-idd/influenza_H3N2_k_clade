...
run_model_once <- function(params) {
  ...
  defaults <- list(
    ...
    prop_immune_younger = 0.3, prop_immune_younger2 = 0.6,
    prop_immune_older = 0.7, prop_immune_oldest = 0.75,
    prop_home_contacts_in_hols = 1, prop_work_contacts_in_hols = 0.75, prop_rest_contacts_in_hols = 1.1,
    prop_all_contacts_christmas = 1.3, prop_rest_contacts_in_christmas = 0.67, prop_home_contacts_in_christmas = 3,
    symp_fracs = c(0.05, 0.2, 0.35, 0.45)
  )
