...
save_wd <- "~/Documents/GitHub/influenza_H3N2_k_clade/new_figures/"
ncol_out  <- 2
...
write.csv(ratio_table %>% arrange(Scenario),"~/Documents/GitHub/influenza_H3N2_k_clade/new_figures/scenario_table.csv")
